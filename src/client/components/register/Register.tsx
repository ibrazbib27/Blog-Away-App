            ...
            state: {
              ...
              body:
                "Congratulations! You have successfully created an account with Blog Away! Welcome to the Family! " +
                  "Next step is to verify your account, check your email inbox follow the instructions in the email in order to " +
                  "verify your account.",
            },
          });
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Row className={"w-100 justify-content-center mx-0 mt-5 mb-4"}>
          <Form.Group className={"my-2 col-12 col-md-10"}>
            <Form.Label className={"required"}>
        ...
        <Row className={"w-100 justify-content-center mb-0 mx-0 mt-0 mb-5"}>
          <Form.Group className={"my-2 col-12 col-md-10"}>
            <Form.Label className={"required"}>
              <b>Role</b>
              <OverlayTrigger

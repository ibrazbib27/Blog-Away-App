...
import { receiveMail } from "../../utils/mailgun/mailgunConfig";
import DB from "../../db";
...
router.post("/contact", async (req, res) => {
    try {
        let data = await receiveMail( 'blog.away.test.demo@gmail.com', req.body.email, req.body.subject, req.body.message);
        res.json(data);
    } catch (e) {
        console.log(e);
        res.sendStatus(500);
